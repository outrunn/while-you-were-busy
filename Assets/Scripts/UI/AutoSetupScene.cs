...
/// Attach to Canvas or call from GameBootstrapper after GameManager initializes.
/// </summary>
public class AutoSetupScene : MonoBehaviour
{
    ...
    private static GameObject CreateAsset(string name, Canvas canvas, Sprite sprite, Vector2 position, Vector2 size)
    {
        ...
        image.raycastTarget = false; // Don't block raycasts for background elements
